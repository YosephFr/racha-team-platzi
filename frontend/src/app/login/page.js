        ...
        >
          {step === 'initial' && (
            <div className="space-y-3">
              ...
              <button
                onClick={() => setStep('email')}
                className="w-full py-3 rounded-2xl text-sm text-muted hover:text-foreground transition-colors"
              >
                Continuar con email
              </button>
            </div>
            ...
            >
              <div className="bg-card rounded-2xl border border-border overflow-hidden shadow-card">
                <input
                  ...
                  autoFocus
                  required
                  className="w-full px-4 py-3.5 bg-transparent text-foreground text-sm placeholder:text-muted/60 focus:outline-none border-b border-border"
                />
                <input
                  type="text"
                  ...
                  className="w-full px-4 py-3.5 bg-transparent text-foreground text-sm placeholder:text-muted/60 focus:outline-none"
                />
              </div>

              {error && <p className="text-danger text-xs text-center px-2">{error}</p>}

              <button
                type="submit"
                disabled={loading || !email}
                className="w-full py-4 rounded-2xl bg-accent text-white font-semibold glow-accent disabled:opacity-50 active:scale-[0.97] transition-all"
              >
