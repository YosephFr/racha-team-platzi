...
import { X, Camera, Image, Upload, Sparkles, CheckCircle, XCircle } from 'lucide-react'
...
export default function StudySheet({ onClose }) {
    ...
    >
      ...
      >
        <header className="shrink-0 px-5 pt-5 pb-3 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="w-10 h-10 rounded-2xl bg-surface flex items-center justify-center text-muted hover:text-foreground transition-colors active:scale-90"
          >
            <X size={20} />
          </button>
        </header>
          ...
          <div className="max-w-md mx-auto">
            <AnimatePresence mode="wait">
              ...
              {phase === 'result' && (
                ...
                >
                  <div className="card-base p-6 text-center mt-4 mb-4">
